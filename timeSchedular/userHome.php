                ...
                if(title === '' || dateAndTime === '')
                    ...
                    obj.onreadystatechange = function()
                    {
                        if(this.readyState == 4 && this.status == 200)
                        {
                            ...
                            document.getElementById("edateandtime").value = ""
                            document.getElementById("redirectLink").value = ""
                        }
                    };
                    obj.open("POST","./ajax.php");
                    obj.setRequestHeader("Content-type","application/x-www-form-urlencoded");
                    obj.send("etitle="+title+"&edesc="+desc+"&edateAndTime="+dateAndTime+'&eredirectLink='+redirectLink);
                }
            }
        ...
        <div class="container my-4 p-4">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 p-5 shadow-lg p-3 mb-5 bg-white rounded">
                    <h3 class="text-primary text-center">Schedule Event</h3>
                    <br>
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <label><span class="text-danger">*</span> Event Title</label><br>
                            <input type="text" class="form-control" placeholder="Enter event title" id="title" />
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <label><span class="text-danger">*</span> Event Date and Time</label><br>
                            <input type="datetime-local" class="form-control" name="edateandtime" id="edateandtime" />
                        </div>
                    </div>
                    <div class="row pt-3">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <label>Event Description</label><br>
                            <textarea class="form-control" rows="5" placeholder="Enet description here..." id="desc"></textarea>
                        </div>
                    </div>
                    <div class="row pt-3">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <label>Event Redirection Link</label><br>
                            <input id="redirectLink" class='form-control' placeholder='Redirection Link'></input>
                        </div>
                    </div>
